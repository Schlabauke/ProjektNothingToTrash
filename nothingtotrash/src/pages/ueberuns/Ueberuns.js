        ...
        <>
            <section className="ueberuns-Sec">
                <div className="content">
                    <div className="ueberuns-Div">
                        <h1>Unsere Vision</h1>
                    </div>
                    <div className="article">
                        <h4>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Tempore delectus illum pariatur unde praesentium ipsa.
                            Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Possimus, quia. Ducimus qui iste praesentium necessitatibus fuga
                            repellat animi. Molestiae, omnis!
                        </h4>
                        <p>
                            Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                            Tempore delectus illum pariatur unde praesentium ipsa.
            ...
            <section className="card">
                <div className="player">
                    <img className="red" src="https://www.pokedexia.net/images/3/34/PGL-007.png" alt="" />
                    <h2>
                        Annnabelle Backend Developerin
                    </h2>
                    <p>
                        Schiggy ist ein kleines, zweibeiniges und schildkrötenähnlichesWikipedia-Icon Pokémon. Es trägt einen braunen Schildkrötenpanzer auf dem Rücken seines hellblau gefärbten Körper, mit einem beigen Bauchpanzer. Das Mittelstück, des mit schwarzen, dünnen Linien versehenen Panzers, ist weiß gehalten. Schiggys Kopf ist rundlicher Gestalt und mit zwei großen Augen versehen, die wiederum aus weißer Lederhaut, violetten Iriden und schwarzen, länglichen Pupillen bestehen. Sein Maul ist recht breit und die Oberlippe leicht eingekrümmt. Die Nasenlöcher sind ebenso wie die Augenbrauen nur leicht angedeutet. Außerdem besitzt Schiggy einen spiralförmigen Schweif. In der schillernden Form hat Schiggy einen grünen Rückenpanzer, der Bauchpanzer ist nun in einem gelblichen Ton gehalten und der Hautton hat zu einem deutlich hellerem Blau gewechselt.
                    </p>
                </div>
                <div className="player " >
                    ...
                    <p>
                        Glurak ist ein Pokémon mit den Typen Feuer und Flug und existiert seit der ersten Spielgeneration. Es stellt die zweite Entwicklungsstufe von Glumanda und Glutexo dar und ist somit neben Bisaflor und Turtok eine der Endentwicklungen der Starter-Pokémon aus Kanto. Seit der sechsten Generation ist es in der Lage, eine Mega-Entwicklung zu Mega-Glurak X oder Mega-Glurak Y zu vollführen, wobei sich bei der Mega-Entwicklung zu Mega-Glurak X sein Typ zu Feuer und Drache ändert; folglich ist es neben Mewtu das einzige Pokémon mit zwei verschiedenen Mega-Entwicklungen. Außerdem kann es seit der achten Generation per Gigadynamaximierung zu Gigadynamax-Glurak werden.
                    </p>
                </div>
                <div className="player" >
                    <img className="red" src="https://assets.pokemon.com/assets/cms2/img/pokedex/full/133.png" alt="" />
                    <h2>
                        Max Frondend Developer
                    </h2>
                    <p>
                ...
                <div className="player">
                    <img className="red" src="https://www.pokedexia.net/images/9/9c/PGL-202.png" alt="" />
                    <h2>
